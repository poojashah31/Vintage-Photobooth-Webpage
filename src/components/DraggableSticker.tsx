...
export function DraggableSticker({
  ...
  // Spring animation for scale — fires on every scale change
  ...
  const handleTouchEnd = useCallback(
    (e: TouchEvent) => {
      ...
      // Finger lifted mid-pinch → resume drag with remaining finger
  ...
  return (
    <motion.div
      ...
      tabIndex={0}
      role="img"
      aria-label="Draggable sticker — use Arrow keys to move, + / - to resize, Delete to remove"
      ...
      className="group focus-visible:ring-2 focus-visible:ring-[#8b4513] focus-visible:ring-offset-1 rounded"
    ...
    >
      <div className="relative">
        ...
        {/* Control buttons — appear on hover or focus */}
